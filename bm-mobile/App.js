...
function ExpensesScreen({ token, buildingId, expenses, categories, reload }) {
  ...
  const openAddExpenseForCategory = (categoryName) => { setCategory(categoryName); setAmount(''); setExpenseDate(todayDate()); setDescription(''); setExpenseFormVisible(true); };
...
const styles = StyleSheet.create({
  ...
  expenseCategoryCard: { backgroundColor: '#fff', borderRadius: 18, marginBottom: 9, flexDirection: 'row-reverse', alignItems: 'stretch', borderWidth: 1, borderColor: '#e2e8f0', overflow: 'hidden' }, expenseCategoryMain: { flex: 1, padding: 13, flexDirection: 'row-reverse', alignItems: 'center', gap: 10 }, categoryQuickAddBtn: { width: 46, margin: 7, borderRadius: 14, backgroundColor: '#0f766e', alignItems: 'center', justifyContent: 'center', shadowColor: '#0f172a', shadowOpacity: 0.12, shadowRadius: 6, elevation: 3 },
